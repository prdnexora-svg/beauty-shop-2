...
export const PRODUCT_TEMPLATES: ProductTemplate[] = [
  // --- flagship / most searched (also the curated "popular" order) ---
  {
    ...
    category: 'Skincare',
    subcategories: ['Face Serums & Actives'],
    emoji: '✨',
  ...
  },
  {
    ...
    category: 'Skincare',
    subcategories: ['Daily Cleansers & Wash'],
    emoji: '🧼',
  ...
  },
  {
    ...
    category: 'Skincare',
    subcategories: ['Day & Night Moisturizers'],
    emoji: '🧴',
  ...
  },
  {
    ...
    category: 'Skincare',
    subcategories: ['Face Masks & Sheets'],
    emoji: '🎭',
  ...
  },
  {
    ...
    category: 'Skincare',
    subcategories: ['Eye & Lip Treatments'],
    emoji: '👁️',
