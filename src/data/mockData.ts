...
export const SEARCH_PRODUCTS: SearchProduct[] = [
  {
    ...
    responseTime: '< 1 hr',
    certifications: ['GMP', 'ISO 9001', 'Halal', 'Organic'],
  ...
  },
  {
    ...
    responseTime: '< 24 hr',
    certifications: ['GST Verified', 'ISO 22716', 'GMP'],
  ...
  },
  {
    ...
    responseTime: '< 2 hr',
    certifications: ['FDA Registered', 'ISO Certified', 'Organic', 'GMP'],
  ...
  },
  {
    ...
    responseTime: '< 2 hr',
    certifications: ['GMP', 'ISO 9001', 'COA', 'Halal'],
  ...
  },
  {
    ...
    responseTime: '< 1 hr',
    certifications: ['ECOCERT Organic', 'GMP', 'ISO 9001'],
  ...
  },
  {
    ...
    responseTime: '< 1 hr',
    certifications: ['ISO 9001', 'GMP Compliant', 'FDA'],
  ...
  },
  {
    ...
    responseTime: '< 1 hr',
    certifications: ['US FDA Reg.', 'ISO 22716 GMP', 'Organic', 'Halal'],
  ...
  },
  {
    ...
    responseTime: '< 2 hr',
    certifications: ['CE Certified', '1-Yr Warranty', 'ISO 9001'],
...
export const SEARCH_SUPPLIERS: SearchSupplier[] = [
  {
    ...
    establishedYearNumber: 2008,
    employeeCount: '250-500 Employees',
    employeeCountNumber: 350,
    certificationsList: ['ISO 9001:2015', 'WHO-GMP Compliant', 'Halal Certified', 'US-FDA Registered'],
    exportReady: true,
    categories: ['Haircare', 'Skincare', 'Keratin Treatments', 'Hair Serums', 'Private Label'],
  ...
  },
  {
    ...
    certificationsList: ['ECOCERT Organic', 'GMP Compliant', 'ISO 9001:2015', 'Cruelty-Free'],
    exportReady: true,
    categories: ['Haircare', 'Skincare', 'Hair Oils', 'Argan Bases', 'Natural Actives', 'Cold Pressed'],
  ...
  },
  {
    ...
    certificationsList: ['US-FDA DMF Registered', 'GMP Compliant', 'ISO 9001:2015', 'Halal'],
    exportReady: true,
    categories: ['Cosmetics', 'Professional Derma', 'Bulk Concentrates', 'Hair Growth Actives', 'Peptides', 'Raw Bases'],
  ...
  },
  {
    ...
    establishedYearNumber: 2012,
    employeeCount: '100-250 Employees',
    employeeCountNumber: 190,
    certificationsList: ['ISO 22716 GMP', 'US-FDA Registered', 'Organic Certified', 'Cruelty-Free'],
    exportReady: true,
    categories: ['Skincare', 'Professional Derma', 'Dermatological Skincare', 'Anti-Aging Creams', 'Serums', 'Sunscreen SPF50'],
  ...
  },
  {
    ...
    certificationsList: ['ISO 9001:2015', 'WHO-GMP Compliant', 'US-FDA Registered', 'EU CPNP Ready'],
    exportReady: true,
    categories: ['Haircare', 'Skincare', 'Haircare Formulations', 'Keratin Treatments', 'OEM Private Label'],
    totalProductsCount: 48,
    minOrderValue: '₹25,000',
    phone: '+91 98201 55443',
    whatsapp: '919820155443',
    locationDetails: {
      industrialZone: 'Andheri MIDC Formulation & R&D Hub',
      fullAddress: 'Plot 12, Cross Road B, MIDC Andheri East, Mumbai, MH 400093',
      city: 'Mumbai',
      state: 'Maharashtra',
      lat: 19.1197,
      lng: 72.8697,
      ...
      dispatchTurnaround: '24 hrs dispatch',
      coldChainAvailable: true,
      transitAdvantage: 'Central Mumbai commercial air freight connectivity'
    }
  },
  {
    id: 'ss-6',
    ...
    certificationsList: ['ISO 9001:2015', 'FDA Food & Cosmetic Grade', 'Heavy Metal Free'],
    exportReady: true,
    categories: ['Cosmetics', 'Salon Equipment', 'Cosmetic Glassware', 'Airless Dispensers', 'Packaging Distribution'],
    totalProductsCount: 86,
    minOrderValue: '₹20,000',
    phone: '+91 98790 44556',
    whatsapp: '919879044556',
    locationDetails: {
      industrialZone: 'Changodar Industrial & Warehousing Estate',
      fullAddress: 'Plot 45-48, Sarkhej-Bavla Highway, Changodar, Ahmedabad, GJ 382213',
      city: 'Ahmedabad',
      state: 'Gujarat',
      lat: 22.9234,
      lng: 72.4412,
      ...
      rawMaterialSources: [],
      customsStatus: 'AEO Certified',
      dispatchTurnaround: 'Same day dispatch',
      coldChainAvailable: false,
      transitAdvantage: 'Direct connectivity to Western Highway and Mundra Port'
    }
  },
  {
    id: 'ss-7',
    name: 'BeautyPro Equipment Co.',
    shortCode: 'BPE',
    type: 'Wholesaler & Equipment Importer',
    city: 'Bengaluru',
    state: 'Karnataka',
    rating: 4.8,
    trustScore: 96,
    ...
    establishedYearNumber: 2017,
    employeeCount: '25-50 Employees',
    employeeCountNumber: 42,
    certificationsList: ['CE Certified Machinery', 'ISO 9001:2015', '1-Yr Warranty Assurance'],
    exportReady: true,
    categories: ['Salon Equipment', 'Ozone Steamers', 'Laser Aesthetic Machines', 'Salon Furniture'],
    totalProductsCount: 65,
    minOrderValue: '₹15,000',
    phone: '+91 98450 11990',
    whatsapp: '919845011990',
    locationDetails: {
      industrialZone: 'Peenya Industrial Area Stage 3',
      fullAddress: 'Phase 3, Peenya Industrial Complex, Bengaluru, KA 560058',
      city: 'Bengaluru',
      state: 'Karnataka',
      lat: 13.0285,
      lng: 77.5197,
