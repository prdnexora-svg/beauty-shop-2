...
CREATE TABLE IF NOT EXISTS profiles_supplier (
  ...
  -- Directory auto-publishing / dynamic filter sync (migration 0009)
  status TEXT NOT NULL DEFAULT 'pending_verification',
  is_verified_supplier BOOLEAN NOT NULL DEFAULT TRUE,
  category TEXT,
  subcategory TEXT,
  brand_name TEXT,
  about TEXT,
...
CREATE INDEX IF NOT EXISTS profiles_supplier_category_idx ON profiles_supplier (category);
CREATE INDEX IF NOT EXISTS profiles_supplier_city_idx     ON profiles_supplier (city);
...
-- ----------------------------------------------------------------------------
-- 10. DYNAMIC CATEGORY / SUBCATEGORY TAXONOMY (RFQ form)
--     Mirror of migrations/0008 so a fresh install from schema.sql alone is
--     functionally identical. Read-only for anon/authenticated.
-- ----------------------------------------------------------------------------
