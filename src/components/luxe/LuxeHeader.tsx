...
const NAV_ITEMS = [
  { label: 'Products', screen: 'plp' },
  { label: 'Suppliers', screen: 'supplier-directory' },
      ...
      <div className="bg-white/95 backdrop-blur-xl border-b border-[#E5D4ED] shadow-[0_4px_24px_-12px_rgba(42,14,63,0.18)]">
        <div className="max-w-[1280px] mx-auto px-4 md:px-6 h-[68px] flex items-center gap-4">
          ...
          <div className="flex items-center gap-2.5">
            ...
            {/* Profile */}
            <button
              onClick={() => (isLoggedIn ? onNavigate(userRole === 'supplier' ? 'supplier-portal' : 'buyer-dashboard') : onOpenAuthModal('login'))}
              aria-label="Account"
